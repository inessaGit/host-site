...
var sortSentence = function(s) {
    ...
    for (let i=0; i<words.length;i++){
       let number=words[i].charAt(words[i].length-1)
        //splice num  from the word 
       words[i]=words[i].substring(0,words[i].length-1)
       map[number]=words[i];
    }
   
   //console.log(map)
  // console.log(Object.values(map)) //[ 'Me', 'Myself', 'and', 'I' ]
   console.log(String(Object.values(map))) //Me,Myself,and,I
